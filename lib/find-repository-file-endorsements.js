 ...
 * @returns {Promise<{endorsements: import("..").DatabaseColumns[], lastCommitSha: string, lastUpdatedAt: string, lastFileSha: string} | undefined>}
 */
export async function findRepositoryFileEndorsements(
  ...
  // get file sha for future checks of changes
